---
title: Payments
description: Meloncart supports multiple payment methods out of the box, so you can offer customers the checkout experience that works best for your business.
layout: doc
aside: false
---
    ...
    <div class="mc-detail-section__visual">
        <div class="mc-mockup">
            ...
            <div class="mc-mockup__screen">
                <img src="/screenshots/payments-gateways.png" alt="Payment gateways" />
            </div>
        </div>
    </div>
</div>
...
<div class="mc-detail-section">
    <div class="mc-detail-section__text">
        ...
        <ul>
            <li><strong>Cash on delivery</strong> to collect payment when the order arrives</li>
            <li><strong>Bank transfer</strong> with account details and manual reconciliation</li>
            <li><strong>Purchase orders / NET terms</strong> for B2B and wholesale billing workflows</li>
            <li><strong>Check or money order</strong> for offline payments with manual confirmation</li>
        </ul>
    ...
    <div class="mc-detail-section__visual">
        <div class="mc-mockup">
            ...
            <div class="mc-mockup__screen">
                <img src="/screenshots/payments-alternative.png" alt="Alternative payment methods" />
            </div>
        </div>
    </div>
</div>
...
<div class="mc-detail-section">
    ...
    <div class="mc-detail-section__visual">
        <div class="mc-mockup">
            ...
            <div class="mc-mockup__screen">
                <img src="/screenshots/payments-order-flow.png" alt="Configurable order flow" />
            </div>
        </div>
    </div>
</div>
...
<div class="mc-detail-section">
    <div class="mc-detail-section__text">
        ...
        <p>Meloncart handles <strong>tax automatically</strong> based on the customer's location. Both tax-inclusive and tax-exclusive pricing models are supported so you can match your region's conventions.</p>
        <p>Multiple tax classes let you apply different rates to different product types (standard, reduced or zero-rated) and tax-exempt customer groups ensure B2B transactions are handled correctly.</p>
    </div>
    <div class="mc-detail-section__visual">
        <div class="mc-mockup">
            <div class="mc-mockup__bar">
            ...
            <div class="mc-mockup__screen">
                <img src="/screenshots/payments-tax.png" alt="Tax calculation" />
            </div>
        </div>
    </div>
</div>
...
<div class="mc-detail-section">
    ...
    <div class="mc-detail-section__visual">
        <img src="/features/feat-invoices.png" alt="Invoices" />
    </div>
</div>
